...
export function RecoverPinScreen() {
    ...
    if (step === 1) {
        return (
            <div className="flex flex-col items-center justify-center h-full p-6 bg-background text-foreground animate-in fade-in slide-in-from-bottom-4 duration-300">
    ...
    return (
        <div className="flex flex-col items-center justify-center h-full p-4 bg-background text-foreground animate-in fade-in duration-300">
