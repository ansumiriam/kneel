...
export function SetupPinScreen() {
    ...
    if (step === 3) {
        return (
            <div className="flex flex-col items-center justify-center min-h-screen p-6 bg-background text-foreground animate-in fade-in slide-in-from-right-4 duration-300">
